...
<div id="wrapper">
    ...
    <?php foreach($data as $value): ?>
        <div class="shortView">
            <div class="picSpan">
                <a href="<?= "images/".$value['id']. "/1.jpg"?>" alt="laptop" class="shortImg laptopsImages" data-lightbox="<?='laptops' . $value['id'] ?>"><img src="<?= "images/".$value['id']. "/1.jpg"?>" alt="laptop" class="shortImg laptopsImages"></a>
